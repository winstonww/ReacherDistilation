...
def get_plot_metadata( date_path ):
    ...
    agent_abrev = { 'KL': 'KL Divergence', 'ret': 'Average reward', 'vfloss': 'l2 Loss of value function prediction' }
    ...
    for filename in filenames:
        match = re.search( r'.*/(.*)_(KL|vfloss|ret).npy', filename, re.M|re.I )
        if match:
